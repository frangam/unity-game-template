...
//		{
			...
			float ht0 = 0f;//m_ocean.SampleHeight(pos + new Vector3(m_spread,0,0));
			float ht1 = 0f;//m_ocean.SampleHeight(pos + new Vector3(-m_spread,0,0));
			float ht2 = 0f;//m_ocean.SampleHeight(pos + new Vector3(0,0,m_spread));
			float ht3 = 0f;//m_ocean.SampleHeight(pos + new Vector3(0,0,-m_spread));
