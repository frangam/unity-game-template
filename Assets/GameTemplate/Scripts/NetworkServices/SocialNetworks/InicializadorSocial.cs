...
public class InicializadorSocial : Singleton<InicializadorSocial> {
	...
	void Awake () {
		...
		if(Configuration.USE_TWITTER){
			...
			AndroidTwitterManager.instance.Init(Configuration.API_KEY, Configuration.API_SECRET);
		}
		#endregion
...
//		}
	...
	private void OnInitTwitter() {
		LoadManager.Instance.TwInited = true;
